...
Revision ID: 938fd6b2fd2d
Revises: 
Create Date: 2023-09-04 08:26:46.855160
...
def upgrade() -> None:
    ...
    op.create_index('idx_doctor', 'route', ['doctor'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_doctor', table_name='route')
    op.drop_table('route')
