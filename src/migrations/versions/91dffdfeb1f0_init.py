...
Revision ID: 91dffdfeb1f0
Revises: 
Create Date: 2023-09-04 21:04:47.689636
...
def upgrade() -> None:
    ...
    op.create_index('idx_doctor_id', 'route', ['doctor_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_doctor_id', table_name='route')
    op.drop_table('route')
